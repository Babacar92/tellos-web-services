...
@ValidatorConstraint({
    name: 'EquipmentTechnicalThumbnailNotExistByColumnConstraint',
    async: true
})
@Injectable()
export class EquipmentTechnicalThumbnailNotExistByColumnConstraint implements ValidatorConstraintInterface {
