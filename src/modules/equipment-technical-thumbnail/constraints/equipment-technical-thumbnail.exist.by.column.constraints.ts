...
@ValidatorConstraint({
    name: 'EquipmentTechnicalThumbnailExistByColumnConstraint',
    async: true
})
@Injectable()
export class EquipmentTechnicalThumbnailExistByColumnConstraint implements ValidatorConstraintInterface {
    ...
    public defaultMessage?(validationArguments?: ValidationArguments): string {
        ...
        if (property === 'value') {
            return this._translationService.trans('The value {value} doesn\'t exist', {
                value: value,
            }, domain).getValue();
        }
