 ...
 */
@Injectable()
export class SupplierLogger extends AbstractLogger {
    public columns: string[] = ['id', 'name', 'active'];

    public entityClassName: string = Supplier.name;
    ...
    public async read(data?: any): Promise<ActionLog> {
        return super.read(ACTION_LOG_TYPES.SUPPLIER_READ, data);
    }

    public async create(data?: any): Promise<ActionLog> {
        return super.create(ACTION_LOG_TYPES.SUPPLIER_CREATE, data);
    }

    public async update(data?: any, oldData?: any): Promise<ActionLog> {
        return super.update(
            ACTION_LOG_TYPES.SUPPLIER_UPDATE,
            data,
            oldData,
        );
    }
    ...
    public async softDelete(data?: any): Promise<ActionLog> {
        return super.remove(
            ACTION_LOG_TYPES.SUPPLIER_SOFT_DELETE,
            data,
        );
    }

    public async delete(data?: any): Promise<ActionLog> {
        return super.remove(ACTION_LOG_TYPES.SUPPLIER_DELETE, data);
    }
}
