...
@ValidatorConstraint({
    name: 'SupplierEvaluationExistByColumnConstraint',
    async: true
})
@Injectable()
export class SupplierEvaluationExistByColumnConstraint implements ValidatorConstraintInterface {
    ...
    public defaultMessage?(validationArguments?: ValidationArguments): string {
        ...
        if (property === 'comment') {
            return this._translationService.trans('The comment {value} doesn\'t exist', {
                value: value,
            }, domain).getValue();
        }
