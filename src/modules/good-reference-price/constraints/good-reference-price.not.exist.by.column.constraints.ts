...
@ValidatorConstraint({
    name: 'GoodReferencePriceNotExistByColumnConstraint',
    async: true
})
@Injectable()
export class GoodReferencePriceNotExistByColumnConstraint implements ValidatorConstraintInterface {
    ...
    public defaultMessage?(validationArguments?: ValidationArguments): string {
        ...
        if (property === 'title') {
            return this._translationService.trans('The title {value} already exist', {
                value: value,
            }, domain).getValue();
        }
