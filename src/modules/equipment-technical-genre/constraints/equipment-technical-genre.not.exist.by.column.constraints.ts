...
@ValidatorConstraint({
    name: 'EquipmentTechnicalGenreNotExistByColumnConstraint',
    async: true
})
@Injectable()
export class EquipmentTechnicalGenreNotExistByColumnConstraint implements ValidatorConstraintInterface {
