...
@ValidatorConstraint({
    name: 'EquipmentTechnicalGenreExistByColumnConstraint',
    async: true
})
@Injectable()
export class EquipmentTechnicalGenreExistByColumnConstraint implements ValidatorConstraintInterface {
