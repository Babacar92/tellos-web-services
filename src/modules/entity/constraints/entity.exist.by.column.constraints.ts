...
@ValidatorConstraint({
    name: 'EntityExistByColumnConstraint',
    async: true
})
@Injectable()
export class EntityExistByColumnConstraint implements ValidatorConstraintInterface {
    ...
    public defaultMessage?(validationArguments?: ValidationArguments): string {
        ...
        if (property === 'label') {
            return this._translationService.trans('The label {value} doesn\'t exist', {
                value: value,
            }, domain).getValue();
        }
