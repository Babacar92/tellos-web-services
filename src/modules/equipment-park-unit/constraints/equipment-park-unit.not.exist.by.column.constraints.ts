...
@ValidatorConstraint({
    name: 'EquipmentParkUnitNotExistByColumnConstraint',
    async: true
})
@Injectable()
export class EquipmentParkUnitNotExistByColumnConstraint implements ValidatorConstraintInterface {

    public constructor(
        private readonly _service: EquipmentParkUnitService,
