...
import { AdministrativeMaterialExistConstraint } from 'src/modules/administrative-material/constraints/administrative-material.exist.constraint';

/**
 * Input for to create a new Quick Access
 */
export class EmployeeCreateArgInput {
    /**
