...
@ValidatorConstraint({
    name: 'LoginNotExistByColumnConstraint',
    async: true
})
@Injectable()
export class LoginNotExistByColumnConstraint implements ValidatorConstraintInterface {
    ...
    public defaultMessage?(validationArguments?: ValidationArguments): string {
        ...
        if (property === 'email') {
            return this._translationService.trans('The email {value} already exist', {
                value: value,
            }, domain).getValue();
