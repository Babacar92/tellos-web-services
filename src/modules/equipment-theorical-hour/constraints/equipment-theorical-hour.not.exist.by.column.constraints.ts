...
@ValidatorConstraint({
    name: 'EquipmentTheoricalHourNotExistByColumnConstraint',
    async: true
})
@Injectable()
export class EquipmentTheoricalHourNotExistByColumnConstraint implements ValidatorConstraintInterface {
