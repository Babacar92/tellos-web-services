...
@ValidatorConstraint({
    name: 'AdministrativeMaterialNotExistByColumnConstraint',
    async: true
})
@Injectable()
export class AdministrativeMaterialNotExistByColumnConstraint implements ValidatorConstraintInterface {
