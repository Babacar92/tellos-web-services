...
@ValidatorConstraint({
    name: 'EquipmentDocumentCheckStartAndEndDateConstraint',
    async: true
})
@Injectable()
export class EquipmentDocumentCheckStartAndEndDateConstraint implements ValidatorConstraintInterface {
